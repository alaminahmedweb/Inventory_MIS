...
namespace WebBasedDiagnosticMIS_MVC.Report.ReportViewer
{
    public partial class StockReceive : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string query = @"SELECT * FROM VW_StockLedgerNew WHERE StockIn>0 AND TrDate BETWEEN '" + dateFrom + "' AND '" + dateTo + "' " + lcCondition + "";
            ...
            rd.Load(Server.MapPath("//Report//ReportFile//ProductReceiving.rpt"));
            rd.SetDataSource(dt);
